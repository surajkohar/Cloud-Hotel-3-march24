...
class SearchController extends Controller
{
    ...
    // old one
//     public function details(Request $request , $hotelID)
//     {
...
// if ($hotelsDetailsFilter['HotelId'] == $hotelID ) {
...
//             'hotelDetailsData' => $newArrayPush,
//             'recommendHotels' => $moreHotelList,
...
//        dd($options);
//    }
    $optionsArrayPagination = customPagination($optionsArray);
// dd($optionsArrayPagination);
    if ($request->ajax()) {
        // dd('ajax called');
...
//    dd($hotelDetails);
// dd($optionsArrayPagination);
//    dd($hotelDetails,$optionsArrayPagination,$selectedHotelID,session()->get('searchParams1'));
    return view('hotel.hotelDetail',[
        'hotelDetailsData' => $hotelDetails,
        'optionsArrayPagination' => $optionsArrayPagination,
        'selectedHotelID'=>$selectedHotelID,
...
// return response()->json(['hotels' => $hotelsOnPage, 'total' => $totalHotels]);
    ...
    public function hotelResults(Request $request){
        ...
        // if(isset($hotels['Response']['Body']['Error']['ErrorText'])) {
        //     return $hotels['Response']['Body']['Error']['ErrorText'];
        // }
        ...
        return view('hotel.holidayList',[
            'hotels' => Splade::onLazy(fn () =>$this->priceAggregatorService->fetchHotels($requestParams)) ,
//            'bulkHotelsMoreDetails' => $outerBulkHotelList,
            'searchParams' => $request->all(),
        ]);
