...
export default {
    ...
    mounted()
     {  this.checkInDate = this.$props.checkInDate;
        this.checkOutDate = this.$props.checkOutDate;
        console.log('checkInDate from props:', this.checkInDate);
        console.log('checkOutDate from props:', this.checkOutDate);
...
this.filteredOptions = [];
    ...
    this.$nextTick(() => {
        ...
        if (!isNaN(checkInDate) && !isNaN(checkOutDate)) {
            ...
            window.location.href = '/hotel/search-results?checkInDate=' + formattedcheckInDate + '&checkOutDate=' + formattedcheckOutDate + '&country=' + this.country + '&city=' + this.city + '&rooms=' + this.rooms + '&adults=' + this.adults + '&children=' + this.children + '&childrenAges=' + this.childrenAges;
        } else {
