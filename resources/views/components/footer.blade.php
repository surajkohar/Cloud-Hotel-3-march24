{{--footer here--}}
<div class="w-auto mt-9 rounded-t-3xl h-auto  bg-white border-4 border-sky-500 p-2">
    <div class=" container mx-auto  bg-white h-auto w-full rounded-xl m-auto p-6 ">
        <div>
        ...
        <div class="  flex justify-around 2xl:flex-row  xl:flex-row lg:flex-row md:flex-row sm:flex-col flex-col mt-[2px] w-full ">
            ...
            <div class="  flex-col float-right 2xl:w-1/3 xl:w-1/3 lg:w-1/3 md:w-full sm:-w-full w-full sm:mt-12 mt-12">
               <div>
                ...
                <div class="mt-2 flex flex-col">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <span class="text-black font-semibold">info@cloudtravels.co.uk</span>
                        </div>
                    </div>
...
<div class="w-full h-10 text-center bg-gray-500 text-white">
    ...
    <div class=" p-5 bg-gray-500 text-white">
        <span class="mt-5">&#169 Copyright 2024 | www.cloudtravels.co.uk All Rights Reserved | <a class="hover:text-[#EAB308]" href="https://himsoftsolution.com/ ">Designed By Him Soft Solution</a></span>
    </div>
</div>
