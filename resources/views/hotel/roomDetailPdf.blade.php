...
{{--                @endforeach--}}
{{--            </ul>--}}
            <table style="width: 100%; font-family: sans-serif; font-weight: normal; font-size: 0.75rem; margin-top: 0.25rem;">
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <ul style="list-style-type: disc; padding-left: 1rem;">
                            @php
                                $count = count($selectedHotelMoreDetails['Facilities']['Facility']);
                                $halfCount = ceil($count / 2); // Round up to ensure even distribution
                            @endphp

                            @foreach ($selectedHotelMoreDetails['Facilities']['Facility'] as $index => $record)
                                @if ($index < $halfCount)
                                    <li>{{ $record['FacilityName'] }}</li>
                                @endif
                            @endforeach
                        </ul>
                    </td>
